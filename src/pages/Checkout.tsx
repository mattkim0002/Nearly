      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          <div className="flex items-center justify-center gap-4">
            ...
            <div className={`w-16 h-1 ${step >= 2 ? 'bg-sky-600' : 'bg-slate-200'}`}></div>
            ...
            <div className={`w-16 h-1 ${step >= 3 ? 'bg-sky-600' : 'bg-slate-200'}`}></div>
              ...
              <div className="bg-white rounded-3xl shadow-xl border-2 border-slate-200 p-8">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input 
                          ...
                          className="w-full px-4 py-3 rounded-lg border-2 border-slate-300 focus:border-sky-500 focus:outline-none"
                        />
                      </div>
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    disabled={processing}
                    className="flex-1 py-4 rounded-xl bg-sky-600 text-white font-semibold hover:bg-sky-700 transition disabled:opacity-50 text-lg"
                  >
                    {processing ? (
              ...
              <div className="bg-white rounded-3xl shadow-xl border-2 border-slate-200 p-8 text-center">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 py-4 rounded-xl bg-sky-600 text-white font-semibold hover:bg-sky-700 transition"
                  >
                    Back to Dashboard
                  </button>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-md border-2 border-slate-200 p-6 sticky top-24">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex justify-between pt-3 border-t-2 border-slate-300">
                  ...
                  <span className="text-lg font-bold text-sky-600">${totalAmount.toFixed(2)}</span>
                </div>
              </div>
