      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-3">
            <div className="w-16 h-16 bg-gradient-to-br from-orange-600 to-blue-500 rounded-2xl flex items-center justify-center">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-4 py-2 rounded-lg border-2 border-slate-300 focus:border-orange-600 focus:outline-none text-sm"
              >
        ...
        {providers.length === 0 ? (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {providers.map((provider) => (
              <div
                key={provider.id}
                className="bg-white rounded-2xl border-2 border-slate-200 hover:border-orange-300 hover:shadow-xl transition p-6 cursor-pointer relative"
              ...
              >
                ...
                <button
                  ...
                  className="absolute top-4 right-4 w-10 h-10 bg-white hover:bg-sky-50 border-2 border-slate-200 hover:border-orange-600 rounded-full flex items-center justify-center transition shadow-md z-10"
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      {provider.verified && (
                        <span className="text-orange-500 text-lg" title="Verified">✓</span>
                      )}
                    </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="font-bold text-orange-500 text-lg">{provider.startingAt}</p>
                  </div>
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
        ...
        {/* CTA Banner */}
        {providers.length > 0 && (
          <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-3xl p-8 text-center text-white mt-12">
            <h2 className="text-2xl font-bold mb-3">Can't find what you're looking for?</h2>
            <p className="text-orange-50 mb-6">Post a job and let local pros come to you!</p>
            <button
              onClick={() => navigate(user ? '/post-job' : '/auth')}
              className="px-8 py-3 bg-white text-orange-500 rounded-xl font-semibold hover:bg-sky-50 transition"
            >
              Post a Job - Free
            </button>
          </div>
