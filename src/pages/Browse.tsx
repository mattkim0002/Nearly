...
<div className="flex items-center gap-4">
  {user ? (
    ...
    <>
      ...
      <button
        onClick={() => navigate('/auth')}
        className="px-5 py-2.5 rounded-full bg-orange-500 text-white hover:bg-orange-600 transition"
      >
        Sign Up
      </button>
    </>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8 border-2 border-slate-200">
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div className="flex items-end">
              <button className="w-full py-3 rounded-xl bg-orange-500 text-white font-semibold hover:bg-orange-600 transition shadow-lg">
                Search
              </button>
            </div>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-md p-6 border-2 border-slate-200 sticky top-24">
              ...
              <div className="mb-6">
                ...
                <select
                  ...
                  className="w-full px-4 py-2 rounded-lg border-2 border-slate-300 focus:border-orange-600 focus:outline-none"
                >
              ...
              <button
                ...
                className="w-full py-2 text-sm text-slate-600 hover:text-orange-500 transition"
              >
                Clear all filters
              </button>
            </div>
                            ...
                            <div className="p-2 max-w-xs">
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                {selectedProvider.verified && (
                                  <span className="text-orange-500" title="Profile verified">✓</span>
                                )}
                              </div>
                              ...
                              <div className="flex items-center justify-between">
                                <span className="font-bold text-orange-500">{selectedProvider.startingAt}</span>
                                <button
              ...
              <div className="space-y-4">
                {filteredProviders.length === 0 ? (
                  ...
                  filteredProviders.map((provider) => (
                    <div
                      key={provider.id}
                      className="bg-white rounded-2xl shadow-md hover:shadow-xl transition p-6 border-2 border-slate-200 hover:border-orange-300 cursor-pointer"
                    >
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            {provider.verified && (
                              <span className="text-orange-500 text-lg" title="Profile verified">✓</span>
                            )}
                            {provider.available && (
                          ...
                          <div className="flex items-center gap-4 text-sm text-slate-600">
                            <span className="font-medium text-orange-500">{provider.service}</span>
