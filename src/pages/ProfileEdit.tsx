        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white rounded-2xl shadow-md border-2 border-slate-200 p-6">
            ...
            <div className="flex items-center gap-6">
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-sky-400 to-blue-600 flex items-center justify-center text-white text-3xl font-bold overflow-hidden">
                {avatarPreview ? (
                    ...
                    <div className="space-y-2">
                      {existingCerts.map((url, idx) => (
                        <div key={idx} className="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                          <a href={url} target="_blank" rel="noopener noreferrer" className="text-sky-600 hover:underline">
                            📄 Certificate {idx + 1}
                          </a>
                          <button
                            type="button"
          ...
          <div className="flex gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 py-4 bg-sky-600 text-white rounded-xl font-semibold hover:bg-sky-700 transition disabled:opacity-50"
            >
