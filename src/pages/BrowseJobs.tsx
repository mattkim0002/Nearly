  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {!loading && filteredJobs.length > 0 && (
          <div className="space-y-4">
            {filteredJobs.map((job) => (
              <div
                key={job.id}
                className="bg-white rounded-2xl border-2 border-slate-200 hover:border-orange-300 hover:shadow-xl transition p-6"
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="ml-4 flex flex-col gap-2">
                    <button
                      ...
                      className="px-6 py-2.5 rounded-xl bg-orange-500 text-white font-semibold hover:bg-orange-600 transition whitespace-nowrap"
                    >
                      Submit Proposal
                    </button>
                    <button
        ...
        {/* Tips Card */}
        {!loading && filteredJobs.length > 0 && (
          <div className="bg-gradient-to-r from-orange-50 to-blue-100 rounded-2xl p-6 mt-8 border-2 border-sky-200">
