    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-sky-50 to-white flex items-center justify-center">
        <div className="text-center">
          ...
          <button onClick={() => navigate('/browse-jobs')} className="px-6 py-3 bg-orange-500 text-white rounded-xl font-semibold hover:bg-orange-600 transition">
            Browse Jobs
          </button>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-md border-2 border-slate-200 p-8">
              ...
              <div className="grid md:grid-cols-3 gap-4 pt-6 border-t border-slate-200">
                <div>
                  ...
                  <p className="font-bold text-xl text-orange-500">{job.budget}</p>
                </div>
                <div>
            ...
            {isAssignedPro && job.status === 'in_progress' && (
              <div className="bg-gradient-to-br from-sky-50 to-blue-50 rounded-2xl shadow-md border-2 border-orange-400 p-8">
                ...
                <div className="mb-8 p-6 bg-sky-50 rounded-xl border-2 border-sky-200">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-3">
                      ...
                      <button onClick={handleSubmitProposal} className="flex-1 py-3 rounded-xl bg-orange-500 text-white font-semibold hover:bg-orange-600 transition">
                        Submit Proposal
                      </button>
                    </div>
                  </div>
