                ...
                {conversations.map((conv) => (
                  <div
                    ...
                    className={`p-4 cursor-pointer hover:bg-sky-50 transition ${
                      selectedConversation === conv.id ? 'bg-sky-50 border-l-4 border-orange-500' : ''
                    }`}
                  >
                  ...
                  <div className="p-4 border-b border-slate-200 bg-slate-50 flex-shrink-0">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="px-4 py-2 rounded-lg bg-orange-50 text-orange-600 hover:bg-sky-200 transition text-sm font-medium"
                      >
                        View Profile
                      </button>
                    </div>
                  ...
                  <div className="p-4 border-t border-slate-200 bg-white flex-shrink-0">
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="px-6 py-3 rounded-xl bg-orange-500 text-white font-semibold hover:bg-orange-600 transition disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        Send
                      </button>
                    </div>
