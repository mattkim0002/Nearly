          ...
          <div key={category.title}>
            ...
            <ul className="space-y-2">
              {category.items.map((item) => (
                <li key={item}>
                  <button className="text-slate-600 hover:text-orange-500 transition text-left">
                    {item}
                  </button>
                </li>
              ))}
...
>
  ...
  {showFindWork && (
    <div className="absolute top-full left-0 mt-2 w-64 bg-white rounded-2xl shadow-2xl border-2 border-slate-200 p-4 animate-fadeIn z-50">
      <ul className="space-y-2">
        {FIND_WORK_ITEMS.map((item) => (
          <li key={item}>
            <button className="w-full text-left px-4 py-2 text-slate-700 hover:bg-sky-50 hover:text-orange-500 rounded-lg transition">
              {item}
            </button>
          </li>
        ))}
    ...
    <button onClick={() => navigate('/pricing')} className="hover:text-orange-500 transition">
      Pricing
    </button>
...
<div className="ml-auto flex items-center gap-4">
  {user ? (
    ...
    <>
      <button
        ...
        className="px-5 py-2.5 text-slate-700 hover:text-orange-500 transition font-medium"
      >
        Log In
      </button>
      <button
  ...
  className="px-8 py-4 text-lg font-semibold rounded-full bg-orange-500 text-white hover:bg-orange-600 transition shadow-xl shadow-sky-200"
>
  Post a Job — Free
</button>
<button 
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {SERVICES.map((service) => (
              <div
                ...
                className="bg-white p-6 rounded-2xl border-2 border-slate-200 hover:border-orange-300 hover:shadow-lg transition cursor-pointer text-center font-medium"
              >
                {service}
              </div>
            ))}
            ...
            {PROVIDERS.map((provider) => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  {provider.verified && (
                    <span className="text-orange-500 text-xl" title="Verified">✓</span>
                  )}
                </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-slate-200">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-full bg-orange-50 text-orange-600 hover:bg-sky-200 transition font-medium text-sm"
                  >
                    View Profile
                  </button>
                </div>
        ...
        <section id="pricing" className="py-16">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl border-2 border-slate-200 p-8">
              ...
              <p className="text-4xl font-bold text-orange-500 mb-4">Free</p>
            ...
            <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl border-2 border-orange-600 p-8 text-white">
        ...
        <section id="post-job" className="py-16 mb-16">
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 max-w-3xl mx-auto border-2 border-slate-200">
            ...
            <form onSubmit={handlePostJob} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full py-4 rounded-xl bg-orange-500 text-white font-semibold text-lg hover:bg-orange-600 transition shadow-lg"
              >
