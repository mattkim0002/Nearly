          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-md border-2 border-slate-200 p-8">
              <div className="text-center mb-6">
                <div className="w-32 h-32 mx-auto rounded-full bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center text-white font-bold text-5xl mb-4 overflow-hidden">
                  {profile?.avatar_url ? (
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full py-3 rounded-xl bg-white border-2 border-orange-200 text-orange-600 font-semibold hover:bg-orange-50 transition flex items-center justify-center gap-2"
                >
                  <span>🚩</span>
              ...
              <div className="bg-white rounded-2xl shadow-md border-2 border-slate-200 p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {profile.skills.map((skill: string, index: number) => (
                    <span
                      key={index}
                      className="px-3 py-1 bg-orange-50 text-orange-600 rounded-full text-sm font-semibold"
                    >
                      {skill}
                    </span>
                  ))}
